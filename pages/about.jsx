...
const About = () => {
  ...
  return (
    <div>
      <Head>
        <title>drey | About</title>
        <meta
          name="description"
          content="Duenas | Backend developer"
        />
            ...
            <Box>
              ...
              <Collapse in={show} startingHeight={100}>
                <Paragraph fontSize="xl" lineHeight={1.6}>
                  ...
                  figma everything changed, I loved it and I developed an
                  interest in UI design, I thought that I will be doing
                  ...
                  understanding C# & Python, I didn't like building apps for
